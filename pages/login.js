            ...
            <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
              ...
              <div className="col-span-3 sm:col-span-2">
                <div className="mt-1 flex rounded-full border text-teal ml-2">
                  ...
                  {...register('password', { required: true })}
                    ...
                    name="password"
                    id="password"
                    className="p-3 pl-6 rounded-full sm:text-sm w-full focus:outline-none focus:ring-1 focus:ring-green-light focus:border-transparent"
              ...
              <div className="col-span-3 sm:col-span-2">
                <div className="flex text-teal ml-2 mt-16">
                  <button type="submit" className="w-full inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium bg-green-light hover:bg-green-default text-white focus:outline-none focus:ring-1 focus:ring-offset-1 focus:ring-none">
                    <span className="text-white text-lg">Submit</span>
                  </button>
                </div>
              </div>
              <div className="text-center mt-2">
                  Don’t have an account? <Link href="/register"><a className="text-green-light hover:text-black"> Sign Up</a></Link>
              </div>
          </div>
        </div>
      </form>
